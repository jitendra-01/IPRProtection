...
def generate_similarity_report(text1, text2, title1, title2, similarity_score):
    hash1 = compute_hash(text1)
    hash2 = compute_hash(text2)
    ...
    report = {
        ...
        "Conclusion": "Highly Similar" if bert_sim > 0.8 else "Moderate" if bert_sim > 0.5 else "Low"
    }
